...
| memory.router.op.noop-routine-tool-result-en | noop | (none) | no |
| memory.router.op.noop-routine-tool-result-ru | noop | (none) | no |
| memory.router.op.noop-small-talk-en | noop | (none) | no |
| memory.router.op.noop-small-talk-ru | noop | (none) | no |
...
| memory.router.op.reinforce-vs-create-duplicate-en | reinforce | noop | no |
...
| memory.router.op.resolve-existing-question-en | resolve | noop | no |
| memory.router.op.resolve-existing-question-ru | resolve | resolve | yes |
...
| memory.router.op.code-switch-ru-en-noop | noop | (none) | no |
