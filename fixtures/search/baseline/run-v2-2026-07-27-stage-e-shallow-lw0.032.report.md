...
| index | 1397 |
| embed | 241144 |
| warm search p50 | 110.465 |
| warm search p95 | 113.479 |
...
| sc-06 | embedder | 2 | `embedder.ts` / `embedBatchAttempt` |
...
| sc-30 | config | — | — |
| sc-31 | storage | 2 | `storage.ts` / `getDeps` |
