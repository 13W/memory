...
| Metric | v1 | v2 | Δ |
| --- | --- | --- | --- |
| Hit@1 | 0.5918 | 0.5102 | -0.0816 |
| Hit@3 | 0.7959 | 0.7347 | -0.0612 |
| Hit@5 / Recall@5 | 0.8367 | 0.7959 | -0.0408 |
| MRR | 0.6963 | 0.6255 | -0.0707 |
...
| index | 1560 |
| embed | 291297 |
| warm search p50 | 114.614 |
| warm search p95 | 120.845 |
...
| sc-02 | embedder | 2 | `embedder.ts` / `embedOne` |
