...
| Metric | v1 | v2 | Δ |
| --- | --- | --- | --- |
| Hit@1 | 0.5918 | 0.5306 | -0.0612 |
| Hit@3 | 0.7959 | 0.7551 | -0.0408 |
| Hit@5 / Recall@5 | 0.8367 | 0.7755 | -0.0612 |
| MRR | 0.6963 | 0.6378 | -0.0585 |
...
| index | 1560 |
| embed | 291297 |
| warm search p50 | 113.618 |
| warm search p95 | 117.486 |
...
| sc-24 | parser | 2 | `indexer/parser.ts` / `extractImports` |
...
| sc-33 | storage | 2 | `storage.ts` / `getMemoryMeta` |
...
| sc-43 | tools | 4 | `tools/forget.ts` / `forgetTool` |
