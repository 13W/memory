...
**Итог ступеней A–D: разрыв по dense-ноге закрыт.** A и B отыграли 0.0136, C — ничего,
D — оставшиеся 0.2068 (0.4939 → 0.7007 при v1 0.6963). Квантование, единственный
кандидат, остававшийся неизмеренным, снято ступенью D как несущественное: q8 достигает
качества BF16. Открытым остаётся не поиск, а **фузия** (D-018): дефолтный гибридный режим
теряет 0.1286 MRR против собственной dense-ноги.
