...
| Metric | v1 | v2 | Δ |
| --- | --- | --- | --- |
| Hit@1 | 0.5918 | 0.4490 | -0.1429 |
| Hit@3 | 0.7959 | 0.6735 | -0.1224 |
| Hit@5 / Recall@5 | 0.8367 | 0.7959 | -0.0408 |
| MRR | 0.6963 | 0.5782 | -0.1180 |
...
| index | 1606 |
| embed | 305379 |
| warm search p50 | 131.362 |
| warm search p95 | 135.533 |
...
| sc-20 | parser | 4 | `indexer/parser.ts` / `walkTree` |
...
| sc-24 | parser | 4 | `indexer/parser.ts` / `extractImports` |
...
| sc-33 | storage | 3 | `storage.ts` / `getMemoryMeta` |
...
| sc-42 | tools | 3 | `tools/stats.ts` / `statsTool` |
| sc-43 | tools | — | — |
