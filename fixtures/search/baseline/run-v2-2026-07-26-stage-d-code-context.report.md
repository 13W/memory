...
| Hit@3 | 0.7959 | 0.7143 | -0.0816 |
| Hit@5 / Recall@5 | 0.8367 | 0.8163 | -0.0204 |
| MRR | 0.6963 | 0.5813 | -0.1150 |
...
| index | 1571 |
| embed | 293485 |
| warm search p50 | 120.276 |
| warm search p95 | 123.881 |
...
| sc-02 | embedder | 5 | `embedder.ts` / `embedOne` |
...
| sc-18 | indexer | 4 | `indexer/indexer.ts` / `CodeIndexer` |
...
| sc-30 | config | — | — |
| sc-31 | storage | — | — |
| sc-32 | storage | 3 | `storage.ts` / `getReverseDeps` |
...
| sc-38 | tools | 4 | `tools/recall.ts` / `recallTool` |
| sc-39 | tools | 2 | `tools/get_file_context.ts` / `getFileContextTool` |
