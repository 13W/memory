...
| index | 1397 |
| embed | 241144 |
| warm search p50 | 110.495 |
| warm search p95 | 113.538 |
...
| sc-06 | embedder | 3 | `embedder.ts` / `embedBatchAttempt` |
...
| sc-30 | config | — | — |
| sc-31 | storage | 3 | `storage.ts` / `getDeps` |
...
| sc-43 | tools | 3 | `tools/forget.ts` / `forgetTool` |
| sc-44 | util | 2 | `util.ts` / `storeMemory` |
| sc-45 | util | 3 | `util.ts` / `colForType` |
