...
| index | 1560 |
| embed | 291297 |
| warm search p50 | 111.840 |
| warm search p95 | 115.869 |
...
| sc-06 | embedder | 4 | `embedder.ts` / `embedBatchAttempt` |
...
| sc-30 | config | — | — |
| sc-31 | storage | 5 | `storage.ts` / `getDeps` |
...
| sc-45 | util | 4 | `util.ts` / `colForType` |
