...
| O6 Retention K/T | T06-01 и метрики | значения конфигурируемы, не считать нормативными | **легитимно открыт для v0 по правилу** — граница явно задокументирована (06§5, 15§4, T17-05 as-built note); телеметрии для вывода реальных K/T нет нигде в коде; provisional-дефолты K=2/T=168h без изменений |
