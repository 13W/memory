...
pub use memory::{
    ...
    RunnerError, ScopeKind, SnapshotOutcome, StaleRun, SupersedeMemoryOp,
    TRANSIENT_BACKOFF_BASE_MS, TRANSIENT_BACKOFF_CAP_MS, UnconsolidatableSession,
    WindowObservation, acquire_lease, active_entries_for_scope, all_memory_entries_with_text,
    apply_create, apply_edit, apply_merge, apply_noop, apply_reinforce, apply_resolve,
    apply_retract, apply_supersede, approve_candidate, candidate_evidence_for, candidate_state,
    ...
    find_by_idempotency_key, has_unconsolidated_checkpoint, insert_audit_event,
    insert_candidate_evidence, insert_memory_evidence, lease_expired, list_candidates,
    list_memory_entries_for_scope, memory_entry_by_id, memory_entry_counts, memory_entry_state,
    memory_entry_summary, memory_evidence_for, observation_evidence_source,
