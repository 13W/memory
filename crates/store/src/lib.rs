...
pub use memory::{
    ...
    CandidateState, CandidateTransitionError, ConsolidationWindow, CreateMemoryEntryError,
    CreateMemoryOp, EditMemoryOp, EvidenceInput, GLOBAL_SCOPE_OWNER_ID, GeneratedOp,
    IllegalCandidateTransition, IllegalMemoryTransition, IllegalRunTransition, LEASE_DURATION_MS,
    LEASE_RENEW_INTERVAL_MS, MemoryCountRow, MemoryEntryRow, MemoryEntrySummary, MemoryKind,
    ...
    NewMemoryEvidence, ProposedOperation, RecallCandidate, ReinforceMemoryOp, RenewError,
    ...
    total_pending_backlog, transition_candidate, transition_memory_entry, transition_run,
