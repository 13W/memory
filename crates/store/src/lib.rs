...
pub use memory::{
    ...
    ResolveMemoryOp, RetractMemoryOp, ReviewError, RunOutcome, RunOutcomeError, RunState,
    RunTransitionError, RunWindow, RunnerApplyError, RunnerError, ScopeKind, SnapshotOutcome,
    StaleRun, SupersedeMemoryOp, WindowObservation, acquire_lease, active_entries_for_scope,
    all_memory_entries_with_text, apply_create, apply_edit, apply_merge, apply_noop,
