...
pub use memory::{
    ...
    ReinforceMemoryOp, RenewError, ResolveMemoryOp, RetractMemoryOp, ReviewError, RunOutcome,
    RunOutcomeError, RunState, RunTransitionError, RunWindow, RunnerApplyError, RunnerError,
    ScopeKind, SnapshotOutcome, StaleRun, SupersedeMemoryOp, WindowObservation, acquire_lease,
    ...
    insert_memory_evidence, lease_expired, list_candidates, memory_entry_state,
    memory_entry_summary, memory_evidence_for, observation_evidence_source, open_next_run,
