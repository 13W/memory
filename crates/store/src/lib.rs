...
pub use memory::{
    ...
    ConsolidationWindow, CreateMemoryEntryError, CreateMemoryOp, EditMemoryOp, EvidenceInput,
    FailureKind, GLOBAL_SCOPE_OWNER_ID, GeneratedOp, IllegalCandidateTransition,
    ...
    NormalizationWrite, PendingNormalization, ProposedOperation, RecallCandidate,
    ReinforceMemoryOp, RenewError, ResolveMemoryOp, RetractMemoryOp, ReviewError, RunCountRow,
    RunOutcome, RunOutcomeError, RunState, RunTransitionError, RunWindow, RunnerApplyError,
    RunnerError, STUCK_RUN_ATTEMPT_THRESHOLD, STUCK_RUN_REASON_MAX_CHARS, ScopeKind,
    SnapshotOutcome, StaleRun, StuckRunRow, SupersedeMemoryOp, TRANSIENT_BACKOFF_BASE_MS,
    TRANSIENT_BACKOFF_CAP_MS, UnconsolidatableSession, UpsertOutcome, WindowObservation,
    acquire_lease, active_entries_for_scope, all_memory_entries_with_text, apply_create,
    ...
    create_candidate, create_consolidation_run, create_memory_entry, delete_normalization,
    edit_candidate, entries_needing_normalization, find_by_idempotency_key,
    ...
    memory_evidence_for, normalization_counts, normalization_for, observation_evidence_source,
