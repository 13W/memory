...
pub use code::{
    ...
    NewResolvedEdge, NewUnresolvedReference, NewlineStyle, OccurrenceMetadata, ParsedUnitOutcome,
    PreparedSource, RevisionOutcome, SOURCE_ENCODING_UTF8, SOURCE_ZSTD_LEVEL, SkipReason,
    SourceCompression, UnitKind, content_blob_exists, content_blob_id,
    content_blob_ids_for_generation, content_hash, create_or_reuse_content_blob,
    ...
    occurrence_ids_for_generation, occurrences_by_id, occurrences_for_fts, occurrences_for_path,
    parsed_unit_id_by_natural_key, parsed_units_for_revision, prepare_source, skip_reason,
    source_bytes, top_imports_for_generation,
};
pub use eviction::{
