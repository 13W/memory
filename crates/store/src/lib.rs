...
pub use memory::{
    Actor, ApplyReport, ApproveCandidateOutcome, AuditEventRow, BacklogBlocker,
    CURRENT_NORMALIZER_VERSION, CandidateCountRow, CandidateRow, CandidateState,
    CandidateTransitionError, ClassifiedFailure, ConfirmMemoryOp, ConsolidationWindow,
    CreateMemoryEntryError, CreateMemoryOp, DeadLetteredNormalization, EditMemoryOp, EvidenceInput,
    ...
    NormalizationStatus, NormalizationWrite, PendingNormalization, ProposedOperation,
    RecallCandidate, ReinforceMemoryOp, RejectMemoryOp, RenewError, ResolveMemoryOp,
    RetractMemoryOp, ReviewError, RunCountRow, RunOutcome, RunOutcomeError, RunState,
    RunTransitionError, RunWindow, RunnerApplyError, RunnerError, STUCK_RUN_ATTEMPT_THRESHOLD,
    STUCK_RUN_REASON_MAX_CHARS, ScopeKind, SessionBacklog, SnapshotOutcome, StaleRun, StuckRunRow,
    SupersedeMemoryOp, TRANSIENT_BACKOFF_BASE_MS, TRANSIENT_BACKOFF_CAP_MS,
