...
pub use memory::{
    Actor, ApplyReport, ApproveCandidateOutcome, AuditEventRow, CandidateCountRow, CandidateRow,
    CandidateState, CandidateTransitionError, ClassifiedFailure, ConsolidationWindow,
    CreateMemoryEntryError, CreateMemoryOp, EditMemoryOp, EvidenceInput, FailureKind,
    GLOBAL_SCOPE_OWNER_ID, GeneratedOp, IllegalCandidateTransition, IllegalMemoryTransition,
    IllegalRunTransition, LEASE_DURATION_MS, LEASE_RENEW_INTERVAL_MS, MemoryCountRow,
    ...
    NewConsolidationRun, NewMemoryEntry, NewMemoryEvidence, ProposedOperation, RecallCandidate,
    ...
    TRANSIENT_BACKOFF_CAP_MS, UnconsolidatableSession, WindowObservation, acquire_lease,
    active_entries_for_scope, all_memory_entries_with_text, apply_create, apply_edit, apply_merge,
    ...
    create_memory_entry, edit_candidate, find_by_idempotency_key, has_unconsolidated_checkpoint,
    ...
    memory_entry_state, memory_entry_summary, memory_evidence_for, observation_evidence_source,
