...
pub use code::{
    ...
    content_blob_id, content_blob_ids_for_generation, content_hash,
    context_subjects_for_generation, create_or_reuse_content_blob, create_or_reuse_file_revision,
    create_or_reuse_parsed_unit, decode_source, delete_unresolved_references_for_revision,
    derive_content_blob, detect_encoding, detect_newline_style, file_revision_id_by_content_key,
    generation_file_occurrence_counts, insert_content_blob, insert_file_revision,
    ...
    occurrences_by_id, occurrences_for_fts, occurrences_for_path, parsed_unit_id_by_natural_key,
...
pub use memory::{
    ...
    ConsolidationWindow, CreateMemoryEntryError, CreateMemoryOp, EditMemoryOp, EffectiveText,
    EvidenceInput, FailureKind, GLOBAL_SCOPE_OWNER_ID, GeneratedOp, IllegalCandidateTransition,
    ...
    NewMemoryEvidence, NormalizationCountRow, NormalizationRow, NormalizationStatus,
    NormalizationView, NormalizationWrite, PendingNormalization, ProposedOperation,
    RecallCandidate, ReinforceMemoryOp, RenewError, ResolveMemoryOp, RetractMemoryOp, ReviewError,
    RunCountRow, RunOutcome, RunOutcomeError, RunState, RunTransitionError, RunWindow,
    RunnerApplyError, RunnerError, STUCK_RUN_ATTEMPT_THRESHOLD, STUCK_RUN_REASON_MAX_CHARS,
    ScopeKind, SnapshotOutcome, StaleRun, StuckRunRow, SupersedeMemoryOp,
    TRANSIENT_BACKOFF_BASE_MS, TRANSIENT_BACKOFF_CAP_MS, UnconsolidatableSession, UpsertOutcome,
    WindowObservation, acquire_lease, active_entries_for_scope,
    all_memory_entries_with_effective_text, apply_create, apply_edit, apply_merge, apply_noop,
    apply_reinforce, apply_resolve, apply_retract, apply_supersede, approve_candidate,
    ...
    create_memory_entry, decide_effective_text, delete_normalization, edit_candidate,
    ...
    memory_entry_state, memory_entry_subject_hash, memory_entry_summary, memory_evidence_for,
