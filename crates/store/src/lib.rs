...
pub use memory::{
    ...
    EditMemoryOp, EffectiveText, EvidenceInput, FailureKind, GLOBAL_SCOPE_OWNER_ID, GeneratedOp,
    ...
    NormalizationCountRow, NormalizationRow, NormalizationStatus, NormalizationView,
    ...
    acquire_lease, active_entries_for_scope, all_memory_entries_with_effective_text, apply_create,
    ...
    decide_effective_text, delete_normalization, edit_candidate, entries_needing_normalization,
    ...
    memory_entry_subject_hash, memory_entry_summary, memory_evidence_for, normalization_backlog,
