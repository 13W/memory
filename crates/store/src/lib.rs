...
pub use memory::{
    ...
    AuditEventRow, BacklogBlocker, CURRENT_NORMALIZER_VERSION, CandidateCountRow, CandidateRow,
    CandidateState, CandidateTransitionError, ClassifiedFailure, ConfirmMemoryOp,
    ...
    RenewError, RepairError, ResolveMemoryOp, RetractMemoryOp, ReviewError, RunCountRow,
    ...
    SessionBacklog, SnapshotOutcome, StaleRun, StuckRunRow, SupersedeMemoryOp,
    ...
    recall_candidate_by_id, recall_candidates_for_scope, record_run_failure, reject_candidate,
    renew_lease, retry_parked_run, retry_run, run_once, session_idle_since,
