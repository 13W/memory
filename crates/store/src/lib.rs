...
pub use memory::{
    ...
    RenewError, ResolveMemoryOp, RetractMemoryOp, ReviewError, RunOutcome, RunOutcomeError,
    RunState, RunTransitionError, RunWindow, RunnerApplyError, RunnerError, ScopeKind,
    SnapshotOutcome, StaleRun, SupersedeMemoryOp, WindowObservation, acquire_lease,
    active_entries_for_scope, apply_create, apply_edit, apply_merge, apply_noop, apply_reinforce,
    apply_resolve, apply_retract, apply_supersede, approve_candidate, candidate_evidence_for,
    candidate_state, canonical_key_owner, commit_apply_run, consolidation_run_state,
    ...
    lease_expired, list_candidates, memory_entry_state, memory_entry_summary, memory_evidence_for,
    observation_evidence_source, open_next_run, pending_candidate_ages, processing_cursor,
    propose_candidate, read_audit_events_for_entity, reject_candidate, renew_lease, retry_run,
